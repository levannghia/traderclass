        ...
        <div class="col-md-8">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="alias" value="<?php echo e(old('alias')); ?>" class="form-control form-control-sm" placeholder="bai-viet">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea name="excerpt" rows="5" class="form-control form-control-sm " placeholder="Mô tả"><?php echo e(old('excerpt')); ?></textarea>
                </div>
                <div class="form-group mb-0">
                    <label for="input_note">Nội dung</label>
                    <textarea name="content" rows="8" class="form-control form-control-sm" placeholder="* Nội dung"><?php echo e(old('content')); ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="meta_title" value="<?php echo e(old('meta_title')); ?>" class="form-control form-control-sm" placeholder="Meta title">
                </div>
                <div class="form-group mb-2">
                    <label for="title">Meta keyword</label>
                    <input type="text"  name="meta_keyword" value="<?php echo e(old('meta_keyword')); ?>" class="form-control form-control-sm" placeholder="Meta keyword">
                </div>
                <div class="form-group mb-0">
                    <label for="input_note">Meta description</label>
                    <textarea name="meta_description" rows="8" class="form-control form-control-sm" placeholder="Meta description"><?php echo e(old('meta_description')); ?></textarea>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/blog/add.blade.php ENDPATH**/ ?>