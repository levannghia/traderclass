                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_blog')); ?>" placeholder="Tiêu đề...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/blog/thumb/<?php echo e($value->photo); ?>' class="rounded-circle"/></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        ...
                                                        <a class="dropdown-item text-danger" href="/admin/blog/status/<?php echo e($value->id); ?>/0"><i class="fe-lock"></i> Khóa</a>
                                                        <?php elseif($value->status==0): ?>
                                                        <a class="dropdown-item text-success" href="/admin/blog/status/<?php echo e($value->id); ?>/1"><i class="fe-check-circle"></i> Kích hoạt</a>
                                                        <?php endif; ?>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules\Dashboard\Views\blog\index.blade.php ENDPATH**/ ?>