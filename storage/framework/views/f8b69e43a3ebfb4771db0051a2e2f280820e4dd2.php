    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card-box">
                ...
                <?php if($data->photo!=""): ?>
                <div class="form-group mb-2">
                    <img src="/public/upload/images/advertisement/large/<?php echo e($data->photo); ?>" style="width: auto;max-width: 100%">
                </div>
                <?php endif; ?>
                <div class="form-group mb-2">
                    <?php
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules\Dashboard\Views\advertisement\edit.blade.php ENDPATH**/ ?>