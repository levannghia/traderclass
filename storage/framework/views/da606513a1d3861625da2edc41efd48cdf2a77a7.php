                        ...
                        <ul>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a style="color: black;" class="dropdown-item" href="/course-introduction">Course
                                        Introduction</a>
                                    ...
                                    <a style="color: black;" class="dropdown-item"
                                        href="/policy/privacy-policy.html">Course
                                        Introduction</a>
                                    <a style="color: black;" class="dropdown-item"
                                        href="/policy/terms-of-service.html">Privacy</a>
                                    <a style="color: black;" class="dropdown-item"
                            ...
                            <li>
                                <a style="padding-top: 0px;" class="nav-link" href="/invite-friends"> <img
                                        class="friend" src="/public/sites/images/add-friend.png" width="16px"
                                        height="16px" style="margin-top: -4px;" alt=""> Invite friends </a>
                            </li>
                            <li>
