            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <select class="form-control form-control-sm" name="type">
                        <option value="1" <?php echo e((old('type')!="" && old('type')==1)? "selected" :""); ?>>Pricing & Payment</option>
                        <option value="0" <?php echo e((old('type')!="" && old('type')==0)? "selected" :""); ?>>General</option>
                    </select>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules\Dashboard\Views\faq\add.blade.php ENDPATH**/ ?>