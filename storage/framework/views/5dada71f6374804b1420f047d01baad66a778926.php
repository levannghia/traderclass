        ...
        <div class="col-md-6">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="name" value="<?php echo e(old('name')); ?>" class="form-control form-control-sm" placeholder="* Tên khóa học">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="id_video" value="<?php echo e(old('id_video')); ?>" class="form-control form-control-sm" placeholder="* Link video">
                </div>
            </div>
        </div>
        <div class="col-md-4">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/video_course/add.blade.php ENDPATH**/ ?>