        ...
        <div class="col-md-6">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="position" value="<?php echo e(old('position')); ?>" class="form-control form-control-sm" placeholder="* Chức vụ">
                </div>
            </div>
        </div>
        <div class="col-md-4">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/teacher/add.blade.php ENDPATH**/ ?>