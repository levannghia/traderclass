                    ...
                    <form action="<?php echo e(route('account.updateinformation')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="image align-item-center">
                            <div class="square align-item-center">
                                ...
                                <?php else: ?>
                                    <img src="public/upload/images/users/thumb/<?php echo e($user->photo); ?>" width="100%"
                                        height="100%" alt="">
                                <?php endif; ?>
                            </div>
                            <div class="text">
                                ...
                                <input type="button" name="selectedFile" id="upimg" value="Upload photos"
                        ...
                        <div class="list-input align-item-center">
                            <div class="input-group">
                                ...
                                <input type="text" style="width: 100%;margin-top: -8px;" name="name"
                        ...
                        <div class="input-group" style="margin-top: 10px;">
                            <label
                                style="text-align: left;width: 100%;margin-bottom: 0;font-size: 13px;margin-bottom: 7px;">Gender
                        ...
                        <div class="input-group phone" style="margin-top: 10px;">
                            <label
                                style="text-align: left;width: 100%;margin-bottom: 0;font-size: 13px;margin-bottom: 7px;">Phone<label
                                    class="important">*</label></label><br>
                            <input type="text" style="width: 100%;margin-top: -8px;" name="phone"
                                value="<?php echo e($user->phone); ?>">
                        </div>
                        <div class="input-group address" style="margin-top: 10px;">
                            <label
                                style="text-align: left;width: 100%;margin-bottom: 0;font-size: 13px;margin-bottom: 7px;">Address<label
                                    class="important">*</label></label><br>
...
<?php endif; ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules\Sites\Views\inc\popupAccount.blade.php ENDPATH**/ ?>