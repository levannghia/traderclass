                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="table-user"><img src='/public/upload/images/crypto/large/<?php echo e($value->image); ?>' class="rounded-circle"/></td>
...
<?php endif; ?>
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/crypto/trash.blade.php ENDPATH**/ ?>