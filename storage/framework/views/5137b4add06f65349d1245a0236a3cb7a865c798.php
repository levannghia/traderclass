                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_admin')); ?>" placeholder="Tên người dùng...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/admins/thumb/<?php echo e($value->photo); ?>' class="rounded-circle"/></td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        ...
                                                        <?php if(Gate::allows('delete', 'Admins')): ?>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules\Dashboard\Views\admin\index.blade.php ENDPATH**/ ?>