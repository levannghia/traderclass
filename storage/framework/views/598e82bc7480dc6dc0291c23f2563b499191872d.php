    ...
    <div class="slimscroll-menu">
        <div id="sidebar-menu">
            <ul class="metismenu" id="side-menu">
                ...
                <?php endif; ?>
                <?php if(Gate::allows('view', 'Advertisement')): ?>
                <li>
                    <a href="javascript: void(0);">
                ...
                <?php endif; ?>
                <?php if(Gate::allows('view', 'Crypto')): ?>
                <li>
                    <a href="javascript: void(0);">
...
</div><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/inc/sidebar.blade.php ENDPATH**/ ?>