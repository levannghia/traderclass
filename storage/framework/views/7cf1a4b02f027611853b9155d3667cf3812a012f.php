        ...
        <div class="col-md-6">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea name="content" rows="8" class="form-control form-control-sm" placeholder="* Nội dung"><?php echo e(old('content',$data->description)); ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-box">
                ...
                <?php if($data->photo!=""): ?>
                <div class="form-group mb-2">
                    <img src="/public/upload/images/testimonials/large/<?php echo e($data->photo); ?>" style="width: auto;max-width: 100%">
                </div>
                <?php endif; ?>
                <div class="form-group mb-2">
                    <?php
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/testimonials/edit.blade.php ENDPATH**/ ?>