                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_order')); ?>" placeholder="Tên người dùng...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php else: ?>
                                            <td class="table-user"><img src='/public/upload/images/users/thumb/<?php echo e($value->photo); ?>' class="rounded-circle"/></td>
                                            <?php endif; ?>
                                            <td><a href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/order-detail/<?php echo e($value->id); ?>" title="chỉ tiết đơn hàng"><?php echo e($value->fullname); ?></a></td>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/order/index.blade.php ENDPATH**/ ?>