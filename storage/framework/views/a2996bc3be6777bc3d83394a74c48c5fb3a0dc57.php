        ...
        <table>
            ...
            <tr class="footer-table">
                ...
                <td class="txt cen">
                    <p>2.000.000 ₫</p>
                    <h5>590.000 ₫</h5>
                    <h4 class="cous"><a style="color: white;" href="./Course selection.html">BUY COURSE</a></h4>
                </td>
                <td class="txt dif">
                    <p>4.000.000 ₫</p>
                    <h5>990.000 ₫</h5>
                    <h4 class="pac"><a style="color: white;" href="./Log into.html">BUY ACCESS PACKAGE</a></h4>
                </td>
            </tr>
        </table>
...
<?php echo $__env->make('Sites::courseIntroduction', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Sites/Views/register/index.blade.php ENDPATH**/ ?>