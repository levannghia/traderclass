            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <select class="form-control form-control-sm" name="teacher_id">
                        ...
                        <option value="<?php echo e($value->id); ?>"><?php echo e($value->fullname); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="form-group mb-2">
                    <label for="title">Link video youtube</label>
                    <input type="text"  name="link_video" value="<?php echo e(old('link_video')); ?>" class="form-control form-control-sm" placeholder="* Link video">
                </div>
            </div>
        </div>
        <div class="col-md-4">
