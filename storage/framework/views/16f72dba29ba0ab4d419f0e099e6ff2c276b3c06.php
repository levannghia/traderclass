...
<form method="post">
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="header-title">Thống kê đơn hàng năm <?php echo e(date("Y")); ?></h4>
                <div id="orders_total" style="height: 350px;" class="flot-chart mt-5"></div>
            </div> <!-- end card-box -->
        </div> <!-- end col -->
        <div class="col-lg-12">
            <div class="card-box">
                <h4 class="header-title">Thống kê tỷ lệ đơn hàng năm <?php echo e(date("Y")); ?></h4>
...
?>
[1, <?php echo e($order_total_mont_1); ?>],
        [2, <?php echo e($order_total_mont_2); ?>],
        [3, <?php echo e($order_total_mont_3); ?>],
        [4, <?php echo e($order_total_mont_4); ?>],
        [5, <?php echo e($order_total_mont_5); ?>],
        [6, <?php echo e($order_total_mont_6); ?>],
        [7, <?php echo e($order_total_mont_7); ?>],
        [8, <?php echo e($order_total_mont_8); ?>],
        [9, <?php echo e($order_total_mont_9); ?>],
        [10, <?php echo e($order_total_mont_10); ?>],
        [11, <?php echo e($order_total_mont_11); ?>],
        [12, <?php echo e($order_total_mont_12); ?>]
...
var y = [], e = [], i = [], l = [], r;
//none
y.push([1, parseInt(<?php echo e($order_none_mont_1); ?>)]);
y.push([2, parseInt(<?php echo e($order_none_mont_2); ?>)]);
y.push([3, parseInt(<?php echo e($order_none_mont_3); ?>)]);
y.push([4, parseInt(<?php echo e($order_none_mont_4); ?>)]);
y.push([5, parseInt(<?php echo e($order_none_mont_5); ?>)]);
y.push([6, parseInt(<?php echo e($order_none_mont_6); ?>)]);
y.push([7, parseInt(<?php echo e($order_none_mont_7); ?>)]);
y.push([8, parseInt(<?php echo e($order_none_mont_8); ?>)]);
y.push([9, parseInt(<?php echo e($order_none_mont_9); ?>)]);
y.push([10, parseInt(<?php echo e($order_none_mont_10); ?>)]);
y.push([11, parseInt(<?php echo e($order_none_mont_11); ?>)]);
y.push([12, parseInt(<?php echo e($order_none_mont_12); ?>)]);
//confirm
e.push([1, parseInt(<?php echo e($order_confirm_mont_1); ?>)]);
e.push([2, parseInt(<?php echo e($order_confirm_mont_2); ?>)]);
e.push([3, parseInt(<?php echo e($order_confirm_mont_3); ?>)]);
e.push([4, parseInt(<?php echo e($order_confirm_mont_4); ?>)]);
e.push([5, parseInt(<?php echo e($order_confirm_mont_5); ?>)]);
e.push([6, parseInt(<?php echo e($order_confirm_mont_6); ?>)]);
e.push([7, parseInt(<?php echo e($order_confirm_mont_7); ?>)]);
e.push([8, parseInt(<?php echo e($order_confirm_mont_8); ?>)]);
e.push([9, parseInt(<?php echo e($order_confirm_mont_9); ?>)]);
e.push([10, parseInt(<?php echo e($order_confirm_mont_10); ?>)]);
e.push([11, parseInt(<?php echo e($order_confirm_mont_11); ?>)]);
e.push([12, parseInt(<?php echo e($order_confirm_mont_12); ?>)]);
//success
i.push([1, parseInt(<?php echo e($order_success_mont_1); ?>)]);
i.push([2, parseInt(<?php echo e($order_success_mont_2); ?>)]);
i.push([3, parseInt(<?php echo e($order_success_mont_3); ?>)]);
i.push([4, parseInt(<?php echo e($order_success_mont_4); ?>)]);
i.push([5, parseInt(<?php echo e($order_success_mont_5); ?>)]);
i.push([6, parseInt(<?php echo e($order_success_mont_6); ?>)]);
i.push([7, parseInt(<?php echo e($order_success_mont_7); ?>)]);
i.push([8, parseInt(<?php echo e($order_success_mont_8); ?>)]);
i.push([9, parseInt(<?php echo e($order_success_mont_9); ?>)]);
i.push([10, parseInt(<?php echo e($order_success_mont_10); ?>)]);
i.push([11, parseInt(<?php echo e($order_success_mont_11); ?>)]);
i.push([12, parseInt(<?php echo e($order_success_mont_12); ?>)]);
//cancel
l.push([1, parseInt(<?php echo e($order_cancel_mont_1); ?>)]);
l.push([2, parseInt(<?php echo e($order_cancel_mont_2); ?>)]);
l.push([3, parseInt(<?php echo e($order_cancel_mont_3); ?>)]);
l.push([4, parseInt(<?php echo e($order_cancel_mont_4); ?>)]);
l.push([5, parseInt(<?php echo e($order_cancel_mont_5); ?>)]);
l.push([6, parseInt(<?php echo e($order_cancel_mont_6); ?>)]);
l.push([7, parseInt(<?php echo e($order_cancel_mont_7); ?>)]);
l.push([8, parseInt(<?php echo e($order_cancel_mont_8); ?>)]);
l.push([9, parseInt(<?php echo e($order_cancel_mont_9); ?>)]);
l.push([10, parseInt(<?php echo e($order_cancel_mont_10); ?>)]);
l.push([11, parseInt(<?php echo e($order_cancel_mont_11); ?>)]);
l.push([12, parseInt(<?php echo e($order_cancel_mont_12); ?>)]);
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/dashboard/index.blade.php ENDPATH**/ ?>