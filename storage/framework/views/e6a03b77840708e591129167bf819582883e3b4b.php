        ...
        <div class="col-md-6">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="fullname" value="<?php echo e(old('fullname')); ?>" class="form-control form-control-sm" placeholder="* Họ và tên">
                </div>
                <div class="form-group mb-2">
                    <label for="title">email</label>
                    <input type="email"  name="email" value="<?php echo e(old('email')); ?>" class="form-control form-control-sm" placeholder="* Email">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text"  name="phone" value="<?php echo e(old('phone')); ?>" class="form-control form-control-sm" placeholder="* số điện thoại">
                </div>
                <div class="form-group mb-2">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\traderclass\app\Modules/Dashboard/Views/admin/add.blade.php ENDPATH**/ ?>