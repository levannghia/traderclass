        ...
        <div class="col-md-6">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea name="content" rows="8" class="form-control form-control-sm" placeholder="* Nội dung">{{ old('content',$data->description) }}</textarea>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-box">
                ...
                @if($data->photo!="")
                <div class="form-group mb-2">
                    <img src="/public/upload/images/testimonials/large/{{$data->photo}}" style="width: auto;max-width: 100%">
                </div>
                @endif
                <div class="form-group mb-2">
                    <?php
