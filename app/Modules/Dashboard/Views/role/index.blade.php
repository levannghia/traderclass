                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <div class="form-inline">
                            ...
                            <a href="/{{ Helper_Dashboard::get_patch() }}/{{ Helper_Dashboard::get_patch(2) }}/add"
                                            ...
                                            @foreach ($data as $value)
                                                <tr>
                                                    <th scope="row"><input type="checkbox" name="check[]"
                                                            value="{{ $value->id }}" /></th>
                                                    <td><a href="/{{ Helper_Dashboard::get_patch() }}/role-permission/{{ $value->id }}"
                                                            title="Xem chi tiết {{ $value->name }}">{{ $value->name }}</a>
                                                    </td>
                                                    <td>{{ $value->Note }}</td>
                                                    <td><a href="/{{ Helper_Dashboard::get_patch() }}/role-permission/{{ $value->id }}"
                                                        title="Chi tiết {{ $value->name }}">Chi tiết</a>
                                                    </td>
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                ...
                                                                <a class="dropdown-item" href="/{{ Helper_Dashboard::get_patch() }}/role-permission/{{ $value->id }}"><i class="fe-eye"></i> Xem chi tiết</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
