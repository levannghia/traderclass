                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="{{Cookie::get('search_order_detail')}}" placeholder="Tên người dùng...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td><a href="/{{Helper_Dashboard::get_patch()}}/order-detail/download-excel/{{$value->id}}" title="xuất đơn hàng ra file excel">{{$value->name}}</a></td>
