                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="{{Cookie::get('search_advertisement')}}" placeholder="Tên quảng cáo...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/advertisement/thumb/{{$value->photo}}' class="rounded-circle"/></td>
