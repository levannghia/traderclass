                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        <a class="dropdown-item" href="/{{Helper_backend::get_patch()}}/{{Helper_backend::get_patch(2)}}/edit/{{$value->id}}"><i class="fe-edit-2"></i> Chỉnh sửa</a>
                                                        @if($value->status==1)
                                                        <a class="dropdown-item text-danger" href="/{{Helper_backend::get_patch()}}/{{Helper_backend::get_patch(2)}}/status/{{$value->id}}/0"><i class="fe-lock"></i> Khóa</a>
                                                        @elseif($value->status==0 || $value->status==2)
                                                        <a class="dropdown-item text-success" href="/{{Helper_backend::get_patch()}}/{{Helper_backend::get_patch(2)}}/status/{{$value->id}}/1"><i class="fe-check-circle"></i> Khôi phục</a>
                                                        @endif
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item text-danger" href='/{{Helper_backend::get_patch()}}/{{Helper_backend::get_patch(2)}}/trash/delete/[{"id":{{$value->id}}}]'><i class="fe-trash-2"></i> Xóa</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
