    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="alias" value="{{ old('alias',$data->alias) }}" class="form-control form-control-sm" placeholder="bai-viet">
                </div>
                <div class="form-group mb-2">
                ...
                <div class="form-group mb-2">
                    ...
                    <textarea  name="excerpt" rows="5" class="form-control form-control-sm " placeholder="Mô tả">{{ old('excerpt',$data->excerpt) }}</textarea>
                </div>
        ...
        <div class="col-md-4">
            <div class="card-box">
                ...
                @if($data->photo!="")
                <div class="form-group mb-2">
                    <img src="/public/upload/images/blog/large/{{$data->photo}}" style="width: auto;max-width: 100%">
                </div>
                @endif
                <div class="form-group mb-2">
                    <?php
            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title',$data->meta_title) }}" class="form-control form-control-sm" placeholder="Meta title">
                </div>
                <div class="form-group mb-2">
                    <label for="title">Meta keyword</label>
                    <input type="text" name="meta_keyword" value="{{ old('meta_keyword',$data->meta_keyword) }}" class="form-control form-control-sm" placeholder="Meta keyword">
                </div>
                <div class="form-group mb-0">
                    <label for="input_note">Meta description</label>
                    <textarea  name="meta_description" rows="8" class="form-control form-control-sm" placeholder="Meta description">{{ old('meta_description',$data->meta_description) }}</textarea>
                </div>
            </div>
        </div>
    </div>
